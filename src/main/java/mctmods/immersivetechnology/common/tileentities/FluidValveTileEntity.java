...
public class FluidValveTileEntity extends CommonValveTileEntity implements IFluidHandler, IFluidPipe, IEBlockInterfaces.IBlockBounds {

	public static DummyTank dummyTank = new DummyTank();

	public FluidValveTileEntity() {
