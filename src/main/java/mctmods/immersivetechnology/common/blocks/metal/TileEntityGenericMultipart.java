...
public abstract class TileEntityGenericMultipart<T extends TileEntityGenericMultipart<T, M>, M extends T> extends TileEntityMultiblockPart<T> implements IMultiblockRender {

    public TileEntityGenericMultipart(int[] structureDimensions) {
