...
public class TileRendererSteamTurbine extends TileRendererMultiblockBase<TileEntitySteamTurbineMaster> {

	public static final TileRendererSteamTurbine renderer = new TileRendererSteamTurbine();
